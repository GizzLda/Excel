...
- **Modo 3:** calcular **preço de venda máximo compatível** a partir do preço de custo.
- Tipo de venda:
...
4. **Preço de venda por custo (novo método)**

Regra: `PreçoCusto >= 0,85 * PreçoVenda - 20,5`

Isolando o preço de venda máximo compatível:

```txt
PreçoVenda_max = (PreçoCusto + 20,5) / 0,85
```
